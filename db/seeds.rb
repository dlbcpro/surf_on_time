...
school01 = SurfSchool.new(name: 'Nomad Surf School', description: 'Ecole de surf au Cap-Ferret', address: '5 Rue des Bernaches, 33970 Lège-Cap-Ferret', website: 'https://nomadsurf.net/',
...
school02 = SurfSchool.new(name: 'Cap Ferret Surf School', description: 'Ecole de surf au Cap-Ferret', address: 'Plage du Truc Vert, 33970 Lège-Cap-Ferret', website: 'https://capferretsurfschool.com/',
...
school03 = SurfSchool.new(name: 'CAPSURF', description: 'Ecole de surf à Hossegor', address: 'Plage Notre Dame, BP28, 40130 Capbreton', website: 'http://www.capsurf.com/',
...
lesson_price_tendancy: '40', rental_price_tendancy: '20')

school04 = SurfSchool.new(name: 'Ecole de Surf des Estagnots', description: 'Ecole de surf à Hossegor', address: 'Plage des estagnots, 40510 Seignosse', website: 'https://www.ecoledesurfestagnots.com/',
...
lesson_price_tendancy: '30', rental_price_tendancy: '10')

school05 = SurfSchool.new(name: '29 Hood École de surf Pors Carn - La Torche', description: 'Ecole de surf à La Toche', address: '433 Rue du Musée de la Préhistoire, 29760 Penmarch', website: 'http://29hood.com/',
...
lesson_price_tendancy: '35', rental_price_tendancy: '15')

school06 = SurfSchool.new(name: 'Surf-attitude', description: 'Ecole de surf à La Torche', address: 'pointe de la Torche, 29120 Plomeur', website: 'http://www.surf-attitude.com/',
...
school07 = SurfSchool.new(name: 'école de surf du Léon à Moguériec', description: 'Ecole de surf à La Mauvaise Grève', address: '170 Pointe de Beg Tanguy, 29250 Sibiril', website: 'http://ecole-surf-leon.com/',
...
school08 = SurfSchool.new(name: 'SurfIn Pourville', description: 'Ecole de surf en Normandie', address: 'Rue du Casino, 76550 Hautot-sur-Mer', website: 'http://www.surfin-pourville.com/',
...
lesson_price_tendancy: '50', rental_price_tendancy: '30')

school09 = SurfSchool.new(name: 'voiles de nacre', description: 'Ecole de surf en Normandie', address: '60 Rue du Général Leclerc, 14830 Langrune-sur-Mer', website: 'http://www.voilesdenacre.fr/',
...
school10 = SurfSchool.new(name: 'Palawaï Surf School', description: 'Ecole de surf à Palavas-les-Flots', address: '37 Boulevard Sarrail, 34250 Palavas-les-Flots', website: 'http://www.palawaisurf-school.com/',
...
school11 = SurfSchool.new(name: 'JEANNOT SURF COACHING', description: 'Ecole de surf à Six-Fours-les-Plages', address: '98 Carraire de Sauviou, 83140 Six-Fours-les-Plages', website: 'https://jeannot-surf-coaching-cours-de-surf.business.site/',
...
lesson_price_tendancy: '20', rental_price_tendancy: '5')

school12 = SurfSchool.new(name: 'Gas Surf Center', description: 'Ecole de surf à La Ciotat', address: 'Avenue des Vieux Moulins, 13600 La Ciotat', website: 'http://www.manipura.com/club/',
